...
* 'Sutasoma Display' was found in:
  ...
  - SutasomaDisplay-Light.ttf (nameID 16) [code: inconsistent-family-name]
</div></details><br></div></details><details><summary><b>[10] SutasomaText-BoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, tifinagh, tai-le, syriac, malayalam, old-permic, coptic, math
 ...
 * U+200C ZERO WIDTH NON-JOINER: try adding one of: brahmi, tamil, mongolian, syloti-nagri, telugu, tirhuta, takri, lepcha, psalter-pahlavi, hanifi-rohingya, kayah-li, oriya, hanunoo, duployan, pahawh-hmong, syriac, sharada, thaana, bengali, cham, sinhala, saurashtra, manichaean, khojki, phags-pa, meetei-mayek, warang-citi, nko, javanese, balinese, gunjala-gondi, gujarati, chakma, kharoshthi, khmer, sogdian, tagbanwa, grantha, limbu, thai, siddham, myanmar, tifinagh, tai-le, khudawadi, buginese, tagalog, mahajani, malayalam, new-tai-lue, avestan, buhid, modi, tibetan, dogra, newa, mandaic, rejang, hatran, tai-tham, devanagari, gurmukhi, yi, tai-viet, kaithi, sundanese, kannada, batak
 * U+200D ZERO WIDTH JOINER: try adding one of: brahmi, tamil, mongolian, old-hungarian, syloti-nagri, telugu, tirhuta, takri, lepcha, psalter-pahlavi, hanifi-rohingya, kayah-li, oriya, hanunoo, duployan, pahawh-hmong, syriac, sharada, thaana, bengali, cham, sinhala, saurashtra, manichaean, khojki, phags-pa, meetei-mayek, warang-citi, nko, javanese, balinese, gunjala-gondi, gujarati, chakma, kharoshthi, tagbanwa, grantha, limbu, thai, siddham, myanmar, tifinagh, tai-le, khudawadi, buginese, tagalog, mahajani, malayalam, new-tai-lue, avestan, buhid, modi, tibetan, dogra, newa, mandaic, rejang, tai-tham, devanagari, gurmukhi, yi, tai-viet, kaithi, sundanese, kannada, batak
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: adlam, mongolian, syloti-nagri, telugu, tirhuta, takri, syriac, hanunoo, duployan, ahom, hebrew, gujarati, old-permic, siddham, tifinagh, devanagari, tai-viet, math, tamil, hanifi-rohingya, pahawh-hmong, sharada, bengali, khojki, meetei-mayek, balinese, gunjala-gondi, khmer, grantha, tai-le, khudawadi, osage, elbasan, modi, tibetan, rejang, yi, myanmar, kaithi, batak, lao, zanabazar-square, bhaiksuki, kayah-li, oriya, cham, sinhala, phags-pa, nko, sogdian, music, limbu, wancho, thai, buginese, mahajani, soyombo, buhid, dogra, newa, caucasian-albanian, mandaic, marchen, coptic, brahmi, symbols, lepcha, psalter-pahlavi, thaana, manichaean, javanese, miao, chakma, kharoshthi, tagbanwa, masaram-gondi, bassa-vah, tagalog, malayalam, new-tai-lue, mende-kikakui, gurmukhi, sundanese, kannada
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-Medium.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaText-SemiBold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-MediumItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-SemiBold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaText-Light.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaText-Medium.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[9] SutasomaText-Italic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaText-Bold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-ExtraBold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaDisplay-BoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaText-ExtraBoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[9] SutasomaText-LightItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-ExtraBoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaText-Regular.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-SemiBoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[9] SutasomaText-MediumItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[12] SutasomaText-ExtraBold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check font names are correct (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/font_names">com.google.fonts/check/font_names</a>)</summary><div>
...
| :--- | :--- | :--- |
| Family Name | Sutasoma Display | Sutasoma Display |
| Subfamily Name | Regular | Regular |
| Full Name | Sutasoma Display Regular | Sutasoma Display Regular |
| Postscript Name | **Sutasoma-DisplayRegular** | **SutasomaDisplay-Regular** | [code: bad-names]
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-LightItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaText-SemiBoldItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-Bold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaText-ExtraLight.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-ExtraLight.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[10] SutasomaText-ExtraLightItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-ExtraLightItalic.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[11] SutasomaDisplay-Light.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Check for codepoints not covered by METADATA subsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/metadata/unreachable_subsetting">com.google.fonts/check/metadata/unreachable_subsetting</a>)</summary><div>
